...
export const MENU_DATA: MenuSection[] = [
  ...
  // 4. Crepe Section
  {
    ...
    items: [
      ...
      { name: 'كريب شاورما', prices: ['80'], description: 'شاورما فراخ + موزاريلا + كريب فاهيتا', isPopular: true },
      ...
      { name: 'كريب زنجر', prices: ['80'], description: 'قطع دجاج مقلية + صوص شيدر + خضار + زيتون + موزاريلا + شرائح الهاليبينو الحارة', isSpicy: true },
      { name: 'كريب دجاج بالكارى', prices: ['80'], description: 'قطع دجاج مقلية متبلة بالكاري مع الخضار + صوص شيدر + زيتون + موزاريلا' },
      { name: 'كريب كرسبي', prices: ['80'], description: 'قطع دجاج مقلية + صوص شيدر + صوص كوكتيل + خضار + زيتون + موزاريلا' },
      { name: 'كريب شيش طاووق', prices: ['80'], description: 'قطع دجاج مشوية مع الخضار + صوص كاجو + صوص شيدر + زيتون + موزاريلا' },
      ...
      { name: 'كريب ميكس فراخ', prices: ['95'], description: 'برجر فراخ + شاورما + قطع كريسبي + صوص كاجو + صوص كوكتيل + زيتون + صوص شيدر + موزاريلا', isPopular: true },
