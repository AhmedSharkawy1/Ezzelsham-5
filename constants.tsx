...
export const CREPE_ADDITIONS = {
  ...
  items: [
    { name: 'سيخ كفتة', prices: ['30'] },
    { name: 'سيخ شيش', prices: ['30'] },
    { name: 'قطعة برجر', prices: ['25'] },
    { name: 'قطعة بانية', prices: ['15'] },
    { name: 'قطعة زنجر', prices: ['25'] },
    { name: 'شاورما', prices: ['25'] },
...
export const MENU_DATA: MenuSection[] = [
  // 1. Pizza Section
  {
    ...
    items: [
      ...
      { name: 'بيتزا ميكس أجبان', description: 'جبنة كيرى + جبنة حلوم + موزاريلا + شيدر', prices: ['100', '125', '140'] },
  ...
  // 3. Shawarma Section
  {
    ...
    items: [
      { name: 'شاورما إكسترا', description: 'إضافة موزاريلا + مشروم', prices: ['90'] },
      { name: 'شاورما كبير', prices: ['75'] },
      { name: 'شاورما صغير', prices: ['70'] },
      { name: 'وجبة شاورما عز الشام العائلي', description: '36 قطعة + تومية + مخلل + بطاطس', prices: ['450'], isPopular: true },
      { name: 'وجبة شاورما عربي', description: 'سندوتش مقطع + تومية + مخلل + بطاطس', prices: ['85'] },
      { name: 'وجبة شاورما عربي دبل', description: '2 سندوتش مقطع + تومية + بطاطس + مخلل', prices: ['160'] },
      { name: 'وجبة ربع كيلو شاورما', description: 'تومية + بطاطس + مخلل + عيش', prices: ['120'] },
      { name: 'فتة شاورما', description: 'تومية + مخلل + أرز + عيش محمص', prices: ['100'] },
      { name: '1 كيلو شاورما', description: 'تومية + بطاطس + مخلل + عيش', prices: ['450'] },
      { name: '½ كيلو شاورما', description: 'تومية + بطاطس + مخلل + عيش', prices: ['225'] },
      { name: 'وجبة شاورما عربي ميني', description: '3 كايزر + تومية + بطاطس + مخلل', prices: ['100'] },
      { name: 'فطيرة عز الشام', description: 'بطاطس + كاتشب', prices: ['120'] },
    ]
  },
  // 4. Crepe Section
  {
    ...
    items: [
      { 
        name: 'كريب بانية', 
        prices: ['60'], 
        description: 'قطع بانية مقلية + صوص كوكتيل + صوص شيدر + خضار + زيتون + موزاريلا' 
      },
      { 
        name: 'كريب كفتة لحم', 
        prices: ['75'], 
        description: 'كفتة لحم + خضار + صوص كوكتيل + صوص شيدر' 
      },
      { 
        name: 'كريب شاورما', 
        prices: ['80'], 
        description: 'شاورما فراخ + موزاريلا + كريب فاهيتا',
        isPopular: true 
      },
      { 
        name: 'كريب فاهيتا', 
        prices: ['80'], 
        description: 'قطع دجاج مشوي مع الخضار + صوص صويا + صوص شيدر + صوص كوكتيل + زيتون + موزاريلا' 
      },
      { 
        name: 'كريب مكسيكي', 
        prices: ['80'], 
        description: 'قطع دجاج مشوي مع الخضار + صوص كوكتيل + صوص شيدر + زيتون + موزاريلا',
        isSpicy: true
      },
      { 
        name: 'كريب زنجر', 
        prices: ['80'], 
        description: 'قطع دجاج مقلية + صوص شيدر + خضار + زيتون + موزاريلا + شرائح الهاليبينو الحارة',
        isSpicy: true
      },
      { 
        name: 'كريب دجاج بالكارى', 
        prices: ['80'], 
        description: 'قطع دجاج مقلية متبلة بالكاري مع الخضار + صوص شيدر + زيتون + موزاريلا' 
      },
      { 
        name: 'كريب كرسبي', 
        prices: ['80'], 
        description: 'قطع دجاج مقلية + صوص شيدر + صوص كوكتيل + خضار + زيتون + موزاريلا' 
      },
      { 
        name: 'كريب شيش طاووق', 
        prices: ['80'], 
        description: 'قطع دجاج مشوية مع الخضار + صوص كاجو + صوص شيدر + زيتون + موزاريلا'
      },
      { 
        name: 'كريب برجر لحم', 
        prices: ['75'], 
        description: 'قطع برجر لحم مشوية + صوص شيدر + موزاريلا' 
      },
      { 
        name: 'كريب برجر فراخ', 
        prices: ['75'], 
        description: 'قطع برجر فراخ مشوية + صوص شيدر + صوص كوكتيل + موزاريلا' 
      },
      { 
        name: 'كريب ميكس فراخ', 
        prices: ['95'], 
        description: 'برجر فراخ + شاورما + قطع كريسبي + صوص كاجو + صوص كوكتيل + زيتون + صوص شيدر + موزاريلا',
        isPopular: true
      },
      { 
        name: 'كريب ميكس لحوم', 
        prices: ['95'], 
        description: 'برجر + هوت دوج + كفتة + خضار + صوص شيدر + موزاريلا' 
      },
      { 
        name: 'كريب سوبريم', 
        prices: ['95'], 
        description: 'رول دجاج محشي ومقلية + صوص شيدر + خضار + زيتون + موزاريلا' 
      },
      { 
        name: 'كريب كرانشي', 
        prices: ['100'], 
        description: 'قطع كريسبي + شرائح سموك تركى مدخن + صوص رانش + صوص شيدر + صوص كوكتيل + خضار + زيتون + ميكس جبن' 
      },
      { 
        name: 'كريب فرانشيسكو', 
        prices: ['100'], 
        description: 'قطع دجاج مشوية مع الخضار + شرائح سموك تركى مدخن + صوص كاجو + صوص شيدر + زيتون + ميكس جبن + مشروم' 
      },
      { 
        name: 'كريب بطاطس', 
        prices: ['45'], 
        description: 'بطاطس مع الخضار + موزاريلا + كاتشب' 
      },
      { 
        name: 'كريب ميكس أجبان', 
        prices: ['70'], 
        description: 'ميكس أجبان عز الشام المميزة + خضار + زيتون + صوصات' 
      },
    ]
  },
  // 5. Meals Section
  {
    ...
    items: [
      { name: 'وجبة برجر لحم', description: '2 قطعة كايزر + تومية + مخلل + بطاطس', prices: ['100'] },
      { name: 'وجبة برجر فراخ', description: '2 قطعة كايزر + تومية + مخلل + بطاطس', prices: ['100'] },
      { name: 'وجبة كرسبي', description: '4 قطع كرسبي + تومية + بطاطس + مخلل + عيش', prices: ['120'] },
      { name: 'وجبة زنجر', description: '4 قطع زنجر + سبايسي + تومية + صوص شيدر + مخلل + عيش', prices: ['130'], isSpicy: true },
      { name: 'وجبة شيش مشوي', description: '2 سيخ شيش + تومية + بطاطس + مخلل + عيش', prices: ['130'] },
      { name: 'وجبة شيش مشوي', description: '2 سيخ شيش + تومية + بطاطس + مخلل + عيش', prices: ['130'] },
      { name: 'وجبة ربع كفتة', description: '2 سيخ كفتة + حمص + أرز + مخلل + عيش', prices: ['100'] },
      { name: 'وجبة كرسبي عائلي', description: '12 قطعة كرسبي + حمص + أرز + مخلل + عيش', prices: ['450'] },
      { name: 'وجبة ميكس وراك', description: 'ورك + سيخ كفتة + سيخ شيش + حمص + أرز + سلطة + مخلل + عيش', prices: ['160'] },
      { name: 'وجبة ميكس صدور', description: 'صدر + سيخ كفتة + سيخ شيش + حمص + أرز + سلطة + مخلل + عيش', prices: ['170'] },
      { name: 'وجبة فحم عائلي', description: ' ½ فرخة + ¼ كفتة + ربع شيش + حمص + تومية + أرز + سلطة + مخلل + عيش', prices: ['300'] },
      { name: 'وجبة جامبو', description: '½ فرخة فحم + سيخ كفتة + سيخ شيش + حمص + تومية + أرز + سلطة + مخلل + عيش', prices: ['250'] },
      { name: 'وجبة حواوشي', description: '2 رغيف حواوشي + حمص + مخلل + بطاطس', prices: ['80'] },
      { name: 'وجبة مشكل', description: '2 قطعة كرسبي + سيخ كفتة + سيخ شيش', prices: ['150'] },
      { name: 'وجبة الروقان', description: 'سيخ كفتة + سيخ شيش + تومية + أرز + بطاطس + سلطة + مخلل + عيش', prices: ['120'] },
    ]
  },
  // 6. Western Sandwiches Section
  {
    ...
    description: 'مع كل 3 سندوتشات طبق توميه ومخلل',
    emoji: '🍔',
  ...
  // 8. Fatteh Section
  {
    ...
    items: [
      { name: 'فتة شاورما', description: 'تومية + مخلل + أرز + عيش محمص', prices: ['100'], isPopular: true },
      { name: 'فتة كرسبي', description: 'تومية + مخلل + أرز + عيش محمص', prices: ['120'] },
      { name: 'فتة زنجر', description: 'تومية + مخلل + موزاريلا + أرز + عيش محمص', prices: ['120'] },
      { name: 'فتة شيش', description: 'تومية + مخلل + موزاريلا + أرز + عيش محمص', prices: ['120'] },
      { name: 'فتة فاهيتا', description: 'تومية + مخلل + موزاريلا + أرز + عيش محمص', prices: ['120'] },
    ]
  },
  // 9. Grills Section (Mushawiyat)
  {
    id: 'grills',
    title: 'قسم المشاوي',
    emoji: '🔥',
    ...
    items: [
      { name: '1 كيلو كفتة', description: 'حمص + أرز + مخلل + عيش', prices: ['400'] },
      { name: '½ كيلو كفتة', description: 'حمص + أرز + مخلل + عيش', prices: ['200'] },
      { name: '1 كيلو شيش', description: 'تومية + بطاطس + أرز + مخلل + عيش', prices: ['420'] },
      { name: '½ كيلو شيش', description: 'تومية + بطاطس + أرز + مخلل + عيش', prices: ['220'] },
      { name: 'فرخة شواية', description: 'تومية + بطاطس + أرز + مخلل + عيش', prices: ['170', '330'], labels: ['نصف', 'كاملة'] },
      { name: 'فرخة على الفحم', description: 'تومية + بطاطس + أرز + مخلل + عيش', prices: ['155', '300'], labels: ['نصف', 'كاملة'], isPopular: true },
      { name: 'فرخة شيش على الفحم', description: 'تومية + بطاطس + أرز + مخلل + عيش', prices: ['155', '350'], labels: ['نصف', 'كاملة'] },
      { name: 'عرض سارى', description: 'فرخة على الفحم + ½ كفتة + تومية + بطاطس + أرز + مخلل + عيش', prices: ['420'], isPopular: true },
    ]
  },
  // 10. Broasted Section
  {
